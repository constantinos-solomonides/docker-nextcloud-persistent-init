...
export NEXTCLOUD_ADMIN_USERNAME="${NEXTCLOUD_ADMIN_USERNAME:-nextclouddbadmin}"
...
function output_cleanup_data(){
    echo "For cleanup container"
    echo "========================"
    echo "  environment:"
    echo '    MARIADB_ROOT_PASSWORD: "${MARIADB_ROOT_PASSWORD}"'
    echo "  volumes:" 
    echo "    - \"${MYSQL_LOCAL_BASE}/:${MYSQL_REMOTE_BASE}/\""
    echo "    - \"${SHARED_LOCAL_BASE}:\${CONTAINER_BASE_DIRECTORY}/\${SHARED_DIRECTORY}\""
}
